...
| ----------------- | -------- | ------- | ------------------------------------------------------------------------------ |
| jdk-version       | False    | 21*     | OpenJDK version. Ignored when `java-version-file` is set                       |
...
\* JDK 21 applies only when neither `jdk-version` nor `java-version-file`
is given. Supplying `java-version-file` takes precedence and suppresses
the default.
...
| Name                          | Required | Default  | Description                                                     |
| ----------------------------- | -------- | -------- | --------------------------------------------------------------- |
| validate-wrappers             | False    | true     | Validate checksums of all `gradlew` jars in the repository      |
